...
def buscar_jogos_e_analisar():
    # Simulação de alerta único com checagem de duplicidade
    jogo_id = "NBA-LALxBOS-20240613"  # ID único para evitar repetição
    ...
    if jogo_id not in alertas_enviados:
        ...
        alertas_enviados.add(jogo_id)
    else:
        print("🔁 Alerta já enviado para este jogo.")
